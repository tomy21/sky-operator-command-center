        ...
        render: (_: Location[keyof Location], location: Location) => (
          <div className="flex space-x-2">
            <button
              ...
              className="cursor-pointer text-green-500 hover:text-green-600 transition-colors duration-200 border border-green-500 hover:border-green-600 hover:bg-green-100 rounded-lg px-2 py-1"
              title="Lihat Detail"
                ...
                <div className="mb-6">
                  <div className="bg-indigo-50 dark:bg-indigo-900/20 border-l-4 border-indigo-500 p-4 rounded">
                    <h2 className="text-lg font-medium text-indigo-700 dark:text-indigo-400 mb-2">
                      Manajemen IP LPR dan Intercome
                    </h2>
                    <p className="text-indigo-600/80 dark:text-indigo-300/80">
                      {" "}
                      Halaman ini untuk menambahkan IP LPR dan Intercome. Klik
                      detail untuk melihat detail lokasi dan lakukan aktivasi
                      dan edit.
                    </p>
                  </div>
                </div>
