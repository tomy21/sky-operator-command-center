...
export const MasterIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TicketIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M2 7a2 2 0 012-2h16a2 2 0 012 2v3a1 1 0 01-1 1 1 1 0 000 2 1 1 0 011 1v3a2 2 0 01-2 2H4a2 2 0 01-2-2v-3a1 1 0 011-1 1 1 0 000-2 1 1 0 01-1-1V7z"
      fill="#374151"
      stroke="none"
    />
...
export const LocationIcon2 = ({ className }: { className?: string }) => (
  <svg
    className={className}
    width="24"
    height="24"
